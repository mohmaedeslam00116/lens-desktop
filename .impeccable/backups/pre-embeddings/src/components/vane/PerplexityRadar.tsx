  ...
  return (
    <div className="w-full space-y-5 select-none">
          ...
          <div className="flex items-center gap-4 overflow-x-auto pb-1 scrollbar-hide">
            ...
            {sources.length > 5 && !showAllSources && (
              <button
                ...
                className="text-[11px] text-slate-500 hover:text-accent transition-colors font-medium shrink-0 px-2"
              >
                  ...
                  <div key={idx} className="relative flex items-start gap-3 py-1.5">
                    ...
                    <div 
                      className={`relative z-10 mt-[3px] shrink-0 ${
                        isCurrent 
                          ? 'w-3.5 h-3.5 rounded-full bg-accent flex items-center justify-center shadow-[0_0_8px_rgba(45,212,191,0.3)]' 
      ...
      {showAllSources && sources.length > 5 && (
        ...
        >
          <div 
            className="w-full max-w-xl max-h-[70vh] bg-canvas rounded-2xl  flex flex-col overflow-hidden"
